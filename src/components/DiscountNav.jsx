...
function DiscountNav() {
  return (
    <div className="h-9 md:mx-2 lg:mx-5 mx-5  bg-gradient-to-r from-[#0d0705] via-[#663b24] to-[#0e0603] rounded-b-xl mt-15 px-23 hidden md:block">
      <div className="h-full flex justify-between items-center text-white">
        ...
        <p className="uppercase text-xs leading-tight">
          <span className="text-black bg-[#F0CE0E] rounded-full font-medium px-2 py-1 mr-1.5">
            Get 40% off
          </span>{" "}
